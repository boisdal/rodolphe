# `Rodolphe jukebox` — the Rodolphe personal assistant jukebox app

This project is an application for a personal assistant with a jukebox, 

## Getting Started

To get you started you can simply clone the `rodolphe` repository and install the dependencies:
...
Clone the `rodolphe` repository using git:

```
git clone https://github.com/boisdal/rodolphe.git
cd rodolphe
```
...
app/                  --> all of the source files for the application
  ...
  view1/                --> the view1 view template and logic
    ...
    jukebox.js              --> the controller logic
    view1_test.js         --> tests of the controller
  view2/                --> the view2 view template and logic
    view2.html            --> the partial template
    settings.js              --> the controller logic
